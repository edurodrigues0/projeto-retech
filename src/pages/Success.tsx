...
export function Success() {
  ...
  return (
    <div className="w-screen p-5 flex items-center justify-evenly gap-24 max-sm:flex-col-reverse max-sm:justify-center max-sm:items-center max-sm:gap-16">
      ...
      <img
        className="w-96 max-sm:w-44 max-sm:mt-16"
        src={successSVG}
